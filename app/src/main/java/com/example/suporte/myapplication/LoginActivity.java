...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            if(firebaseAuth.getCurrentUser() != null){
                ...
                Intent intent = new Intent(LoginActivity.this, LancamentosActivity.class);
    ...
    private void alertNovoUsuario(final Usuario usuario) {
        AlertDialog.Builder builder = new AlertDialog.Builder(
                this);
        builder.setMessage("Usuário não cadastrado. Deseja cadastrar usuário?")
                .setCancelable(false)
                .setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        firebaseAuth.createUserWithEmailAndPassword(email, senha.toString())
